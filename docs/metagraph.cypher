...
(_description:_Property {description:'longer description',_fieldtype:'string',_id:'def2',_techname:'description', graph:'metagraph'}),
(_techname:_Property {description:'internal scalar representation',_fieldtype:'string',_id:'def3',_techname:'_techname', graph:'metagraph'}),
(_prop:_Relation {description:'_Schema --_PROP-> _Property',_targetarity:'*',_id:'def5',_sourcearity:'*',_techname:'_PROP', graph:'metagraph'}),
(_arity:_Property {description:'How often can there be the element',_fieldtype:'string',_id:'def7',_techname:'_arity', graph:'metagraph'}),
...
(_fieldtype:_Property {description:'Von welchem Typ ist der Wert',_fieldtype:'string',_id:'def10',_techname:'_fieldtype', graph:'metagraph'}),
(_name:_Property {description:'full name of  thing',_fieldtype:'string',_id:'def11',_techname:'name', graph:'metagraph'}),
(_person:_Schema {description:'a human',_id:'def12',_schemaname:'Person',_techname:'Person', graph:'metagraph'}),
(_firstname:_Property {description:'first name of a person',_fieldtype:'string',_id:'def13',_techname:'firstname', graph:'metagraph'}),
(_lastname:_Property {description:'last name of a person',_fieldtype:'string',_id:'def14',_techname:'lastname', graph:'metagraph'}),
...
(_schemaname:_Property {description:'the name of a schema',_fieldtype:'string',_id:'def18',_techname:'_schemaname', graph:'metagraph'}),
(_sourcearity:_Property {description:'_arity of start',_fieldtype:'string',_id:'def19',_techname:'_sourcearity', graph:'metagraph'}),
(_targetarity:_Property {description:'_arity of target',_fieldtype:'string',_id:'def20',_techname:'_targetarity', graph:'metagraph'}),
...
(_prop)-[:_SOURCE {_id:'def24', graph:'metagraph'}]->(_schema),
...
(_property)-[:_PROP {_id:'def32',_arity:'1', graph:'metagraph'}]->(_fieldtype),
...
(_likes)-[:_SOURCE {_id:'def39', graph:'metagraph'}]->(_person),
(_likes)-[:_TARGET {_id:'def40', graph:'metagraph'}]->(_person),
(_source)-[:_SOURCE {_id:'def41', graph:'metagraph'}]->(_relation),
(_source)-[:_TARGET {_id:'def42', graph:'metagraph'}]->(_schema),
(_target)-[:_SOURCE {_id:'def43', graph:'metagraph'}]->(_relation),
